...
### Prerequisites
- Node.js 22 LTS (Node 18 through 24 are supported)
- npm or yarn
...
# For deployed usage, set VITE_API_URL to your backend Render URL
...
- Set `VITE_API_URL` in environment variables to your backend URL
